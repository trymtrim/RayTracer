...
namespace RayTracerTestBed
{
	...
	class Scene
	{
		...
		private void SpawnMap1()
		{
			...
			meshes.Add(plane);
			Material planeMaterial = new Material(Texture.Checkerboard, Vector3.One, 0.8f);
			materials.Add(planeMaterial);

			//Grey sphere
			Mesh sphere1 = new Sphere(new Vector3(-4.0f, 1.0f, 6.0f), 1.0f, "Sphere1");
			meshes.Add(sphere1);
			Material sphere1Material = new Material(Texture.Color, new Vector3(0.7f, 0.7f, 0.7f));
