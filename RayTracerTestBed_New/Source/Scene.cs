...
namespace RayTracerTestBed
{
	...
	class Scene
	{
		...
		{
			//var from = new Vector3(10.0f, -5.0f, 1.0f);
			//var on = new Vector3(-1.0f, -1.0f, 9.0f);
			//Light light = new Light(LightType.Spherical, new Vector3(1.0f, 1.0f, 1.0f), new Vector3(0.0f, 1.0f, 0.0f), 50.5f);
			...
			Mesh sphere1 = new Sphere(new Vector3(-2.5f, 1.0f, 6.0f), 1.0f); //Grey sphere
			meshes.Add(sphere1);
			Material sphere1Material = new Material(new Vector3(0.7f, 0.7f, 0.7f));
			materials.Add(sphere1Material);

			Mesh sphere2 = new Sphere(new Vector3(2.5f, -2.5f, 9.0f), 2.0f); //Large blue sphere higher up
			meshes.Add(sphere2);
			...
			meshes.Add(sphere3);
			Material sphere3Material = new Material(new Vector3(1.0f, 1.0f, 1.0f), 0.9f); //REMINDER: Put white to get full mirror effect
