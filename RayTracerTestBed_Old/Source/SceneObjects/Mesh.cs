...
namespace RayTracerTestBed
{
	class Mesh
	{
		...
		public virtual bool Intersect(Ray ray, out float tNear, out int index, out Vector2 uv)
		{
			//Default out values
		...
		public virtual void GetSurfaceProperties(Vector3 p, Vector3 i, int index, Vector2 uv, out Vector3 n, out Vector2 st)
		{
			//Default out values
			n = new Vector3(0.0f);
			st = new Vector2(0.0f);
		...
		public virtual Vector3 EvaluateDiffuseColor(Vector2 st)
		{
			return diffuseColor;
		}
